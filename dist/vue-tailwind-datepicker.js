...
import { cloneVNode as Xt, h as ve, Fragment as xe, inject as De, provide as se, ref as J, onMounted as ot, watchEffect as _e, computed as ue, defineComponent as de, onUnmounted as et, Teleport as ht, reactive as yt, shallowRef as Qt, openBlock as z, createElementBlock as Z, createElementVNode as Y, withDirectives as me, vShow as pe, toDisplayString as ae, renderList as Ke, withModifiers as $e, unref as le, createCommentVNode as ye, createVNode as ee, TransitionGroup as eo, withCtx as Be, normalizeClass as Te, Transition as bt, nextTick as Ue, watch as it, isProxy as to, createBlock as Fe, renderSlot as ct, mergeProps as oo, vModelText as ro } from "vue";
function Oe(e, r, ...u) {
  if (e in r) {
    let a = r[e];
...
function Pe({ visible: e = !0, features: r = 0, ourProps: u, theirProps: t, ...a }) {
  var n;
  let v = xt(t, u), s = Object.assign(a, { props: v });
  if (e || r & 2 && v.static)
    return st(s);
  if (r & 1) {
...
function st({ props: e, attrs: r, slots: u, slot: t, name: a }) {
  ...
  if (s === "template") {
    if (c = gt(c ?? []), Object.keys(h).length > 0 || Object.keys(r).length > 0) {
      let [b, ...S] = c ?? [];
      if (!so(b) || S.length > 0)
...
`)].join(`
`));
      let V = xt((v = b.props) != null ? v : {}, h), I = Xt(b, V);
      for (let x in V)
...
function gt(e) {
  return e.flatMap((r) => r.type === xe ? gt(r.children) : [r]);
}
function xt(...e) {
  if (e.length === 0)
    return {};
...
function xo(e, r, u = ue(() => !0)) {
  function t(n, v) {
    ...
    return !jt(s, dt.Loose) && s.tabIndex !== -1 && n.preventDefault(), r(n, s);
  }
  let a = J(null);
  Ge("pointerdown", (n) => {
    var v, s;
  ...
  }, !0), Ge("touchend", (n) => t(n, () => n.target instanceof HTMLElement ? n.target : null), !0), _t("blur", (n) => t(n, () => window.document.activeElement instanceof HTMLIFrameElement ? window.document.activeElement : null), !0);
}
...
de({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: r, attrs: u }) {
  let t = J(null), a = ue(() => Ae(t)), n = ko(), v = De(St, null), s = J(n === !0 || v == null ? jo(t.value) : v.resolveTarget());
  _e(() => {
  ...
  return ot(() => {
    ...
    return ve(ht, { to: s.value }, Pe({ ourProps: c, theirProps: e, slot: {}, attrs: u, slots: r, name: "Portal" }));
  };
} });
...
let St = Symbol("PortalGroupContext");
...
function $o({ defaultContainers: e = [], portals: r, mainTreeNodeRef: u } = {}) {
  ...
  return { resolveContainers: n, contains(v) {
    ...
    return u != null ? null : ve(We, { features: Re.Hidden, ref: t });
  } };
}
function Mo() {
  let e = J(null);
  return { mainTreeNodeRef: e, MainTreeNode() {
    return ve(We, { features: Re.Hidden, ref: e });
  } };
}
var So = ((e) => (e[e.Open = 0] = "Open", e[e.Closed = 1] = "Closed", e))(So || {});
let Dt = Symbol("PopoverContext");
function nt(e) {
  let r = De(Dt, null);
  if (r === null) {
    let u = new Error(`<${e} /> is missing a parent <${Tt.name} /> component.`);
    throw Error.captureStackTrace && Error.captureStackTrace(u, nt), u;
  }
  return r;
}
let Ot = Symbol("PopoverGroupContext");
function Pt() {
  return De(Ot, null);
}
let Vt = Symbol("PopoverPanelContext");
function Do() {
  return De(Vt, null);
}
let Tt = de({ name: "Popover", inheritAttrs: !1, props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: r, attrs: u, expose: t }) {
  var a;
  let n = J(null);
  t({ el: n, $el: n });
  ...
  se(Dt, V), io(ue(() => Oe(v.value, { 0: Le.Open, 1: Le.Closed })));
  let I = { buttonId: V.buttonId, panelId: V.panelId, close() {
    V.closePopover();
  } }, x = Pt(), D = x == null ? void 0 : x.registerPopover, [E, k] = _o(), w = $o({ mainTreeNodeRef: x == null ? void 0 : x.mainTreeNodeRef, portals: E, defaultContainers: [s, g] });
  function P() {
    var T, O, l, o;
  ...
  return _e(() => D == null ? void 0 : D(I)), wo((a = b.value) == null ? void 0 : a.defaultView, "focus", (T) => {
    ...
    var l;
    V.closePopover(), jt(O, dt.Loose) || (T.preventDefault(), (l = H(s)) == null || l.focus());
  }, ue(() => v.value === 0)), () => {
...
} }), Oo = de({ name: "PopoverButton", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: !1 }, id: { type: String, default: () => `headlessui-popover-button-${Ne()}` } }, inheritAttrs: !1, setup(e, { attrs: r, slots: u, expose: t }) {
  ...
  let v = Pt(), s = v == null ? void 0 : v.closeOthers, h = Do(), c = ue(() => h === null ? !1 : h.value === a.panelId.value), g = J(null), b = `headlessui-focus-sentinel-${Ne()}`;
  c.value || _e(() => {
  ...
  return () => {
    ...
    return ve(xe, [Pe({ ourProps: l, theirProps: { ...r, ...O }, slot: P, attrs: r, slots: u, name: "PopoverButton" }), w && !c.value && a.isPortalled.value && ve(We, { id: b, features: Re.Focusable, "data-headlessui-focus-guard": !0, as: "button", type: "button", onFocus: k })]);
  };
  ...
  let t = nt("PopoverOverlay"), a = `headlessui-popover-overlay-${Ne()}`, n = kt(), v = ue(() => n !== null ? (n.value & Le.Open) === Le.Open : t.popoverState.value === 0);
  function s() {
    t.closePopover();
  }
  return () => {
...
} }), Vo = de({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, focus: { type: Boolean, default: !1 }, id: { type: String, default: () => `headlessui-popover-panel-${Ne()}` } }, inheritAttrs: !1, setup(e, { attrs: r, slots: u, expose: t }) {
  let { focus: a } = e, n = nt("PopoverPanel"), v = ue(() => Ae(n.panel)), s = `headlessui-focus-sentinel-before-${Ne()}`, h = `headlessui-focus-sentinel-after-${Ne()}`;
  ...
  let c = kt(), g = ue(() => c !== null ? (c.value & Le.Open) === Le.Open : n.popoverState.value === 0);
  function b(D) {
    var E, k;
    switch (D.key) {
      case Ve.Escape:
  ...
  return () => {
    ...
    return Pe({ ourProps: P, theirProps: { ...r, ...w }, attrs: r, slot: D, slots: { ...u, default: (...T) => {
      var O;
      return [ve(xe, [g.value && n.isPortalled.value && ve(We, { id: s, ref: n.beforePanelSentinel, features: Re.Focusable, "data-headlessui-focus-guard": !0, as: "button", type: "button", onFocus: I }), (O = u.default) == null ? void 0 : O.call(u, ...T), g.value && n.isPortalled.value && ve(We, { id: h, ref: n.afterPanelSentinel, features: Re.Focusable, "data-headlessui-focus-guard": !0, as: "button", type: "button", onFocus: x })])];
...
de({ name: "PopoverGroup", inheritAttrs: !1, props: { as: { type: [Object, String], default: "div" } }, setup(e, { attrs: r, slots: u, expose: t }) {
  ...
  return se(Ot, { registerPopover: c, unregisterPopover: h, isFocusWithinPopoverGroup: g, closeOthers: b, mainTreeNodeRef: s.mainTreeNodeRef }), () => ve(xe, [Pe({ ourProps: { ref: a }, theirProps: { ...e, ...r }, slot: {}, attrs: r, slots: u, name: "PopoverGroup" }), ve(s.MainTreeNode)]);
} });
        ...
        if (typeof o == "string") {
          ...
          N && (K = l[2]), s = this.$locale(), !R && K && (s = E.Ls[K]), this.$d = function(M, A, $) {
            try {
              ...
              var ge = te || 0, ke = oe || 0, Ie = ie || 0, He = we || 0;
              return ne ? new Date(Date.UTC(re, fe, he, ge, ke, Ie, He + 60 * ne.offset * 1e3)) : $ ? new Date(Date.UTC(re, fe, he, ge, ke, Ie, He)) : new Date(re, fe, he, ge, ke, Ie, He);
            } catch {
              return /* @__PURE__ */ new Date("");
            }
...
const pt = Object.fromEntries(
...
}), Rt = Symbol("isBetweenRange"), It = Symbol(
  "betweenRangeClasses"
), Ht = Symbol("datepickerClasses"), Ut = Symbol("atMouseOver"), zt = Symbol("setToToday"), Wt = Symbol("setToYesterday"), Kt = Symbol("setToLastDay"), Gt = Symbol("setToThisMonth"), Zt = Symbol("setToLastMonth"), qt = Symbol("setToCustomShortcut"), lr = {
  key: 0,
  ...
  setup(e) {
    const r = e, u = je(zt), t = je(Wt), a = je(Kt), n = je(Gt), v = je(Zt), s = je(qt), h = ue(() => typeof r.shortcuts == "function" ? r.shortcuts() : !1);
  ...
  emits: ["updateDate"],
  setup(e, { emit: r }) {
    const u = r, t = je(Rt), a = je(It), n = je(Ht), v = je(Ut);
...
const Mr = ["disabled", "placeholder", "onKeyup"], Sr = { class: "absolute inset-y-0 right-0 inline-flex items-center rounded-md overflow-hidden" }, Dr = ["disabled"], Or = {
  ...
  setup(e, { expose: r, emit: u }) {
    ...
    const V = J(null), I = J(null), x = J(null), D = J(""), E = J(null), k = J(""), w = J([]), P = J([]), T = J(null), O = J(null), l = yt({
      previous: {
        calendar: !0,
        month: !1,
        year: !1
    ...
    return se(Rt, te), se(It, ie), se(Ht, oe), se(Ut, Q), se(zt, be), se(Wt, he), se(Kt, re), se(Gt, fe), se(Zt, ge), se(qt, ke), (p, f) => t.noInput ? K.value ? (z(), Z("div", Zr, [
      Y("div", qr, [
        Y("div", Jr, [
          t.shortcuts ? (z(), Fe(vt, {
            key: 0,
      ...
      default: Be(({ open: m }) => [
        t.overlay && !t.disabled ? (z(), Fe(le(Po), {
          key: 0,
          ...
          default: Be(() => [
            (z(), Fe(ht, { to: "body" }, [
              t.disabled ? ye("", !0) : (z(), Fe(le(Vo), {
                ...
                default: Be(({ close: d }) => [
                  Y("div", {
                    class: Te(["absolute z-50 top-full sm:mt-2.5", He(m)])
                  }, [
                    Y("div", {
                      ref_key: "VtdRef",
                      ref: V,
                      ...
                      Y("div", {
                        class: Te(["vtd-datepicker static sm:relative w-full bg-white sm:rounded-lg sm:shadow-sm border-0 sm:border border-black/[.1] px-3 py-3 sm:px-4 sm:py-4 dark:bg-vtd-secondary-800 dark:border-vtd-secondary-700/[1]", Ie(m)])
                      }, [
                        Y("div", Tr, [
                          t.shortcuts ? (z(), Fe(vt, {
                            key: 0,
